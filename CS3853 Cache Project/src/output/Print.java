...
public class Print {
	...
	public static void printHeader(ArrayList<Instruction> list) {
		...
		System.out.printf("Unused Cache Space:\t%.2f KB / %.2f KB = %.2f%%  Waste: $%.2f\n", cache.unusedKB(), cache.implementSize(), (cache.unusedKB() * 100) / cache.implementSize(), cache.waste());
		System.out.printf("Unused Cache Blocks:\t%d / %d", cache.unusedCache(), cache.totalBlocks());
	}
